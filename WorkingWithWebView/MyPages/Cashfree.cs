...
public class Cashfree : ContentPage
{
    public Cashfree()
    {
        ...
        // variables to be passed to Cashfree page.
    ...
    public void LoadCashfreePage(string appId, string orderId, string orderAmount, string orderNote, string customerName, string customerEmail, string customerPhone, string signature, string onClickBackCFUrl)
    {
        ...
        //TODO: Research on HtmlWebViewSource and WebView
        // If you want to present a string of HTML defined dynamically in code, 
        // you'll need to use an instance of HtmlWebViewSource and set its Html property to the HTML string.
        var htmlSource = new HtmlWebViewSource();
        htmlSource.Html = cfHtmlStr;

        //TODO: see: https://learn.microsoft.com/en-us/xamarin/xamarin-forms/user-interface/webview?tabs=macos
